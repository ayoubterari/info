...
import { User, Settings, BarChart3, MessageSquare, HelpCircle, Send, DollarSign, TrendingUp, CheckCircle, Clock, Home, Wallet } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          ...
          <TabsContent value="wallet" className="space-y-4" forceMount>
            <div className={activeTab === 'wallet' ? 'block' : 'hidden'}>
              <WalletTab userId={user?.userId} />
            </div>
          </TabsContent>
