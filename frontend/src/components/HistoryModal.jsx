...
export default function HistoryModal({ isOpen, onClose }) {
  ...
  const conversations = useQuery(api.conversations.getConversations, { limit: 50 });
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div className="flex justify-end">
                  <div className="max-w-[80%] bg-blue-600 text-white rounded-2xl rounded-tr-sm p-4 shadow-md">
